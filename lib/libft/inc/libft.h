...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/10/25 17:11:15 by kmushta           #+#    #+#             */
/*   Updated: 2017/10/25 17:11:17 by kmushta          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned int			ft_printf_max3(unsigned int a, unsigned int b,
	unsigned int c);
...
unsigned int			ft_printf_read_modificators(const char *format,
	int *arr);
int						ft_printf_read_transformation(const char *format,
	int *arr);
